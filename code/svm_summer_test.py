...
# Set information
m_train = 2668    # Number of training examples
...
y = np.zeros([m_train])
with open('complete_project_data_09_05.csv') as csv_file:
...
m_valid = 553    # Number of training examples
...
y = np.zeros([m_valid])
with open('complete_project_data_06_08.csv') as csv_file:
    csv_reader = csv.reader(csv_file, delimiter=',')
    line_count = 0
    for row in csv_reader:
        if line_count != 0:
